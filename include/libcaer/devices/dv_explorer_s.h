...
#define DVX_S_DVS_SUBSAMPLE_VERTICAL_NONE 0
#define DVX_S_DVS_SUBSAMPLE_VERTICAL_HALF 1
#define DVX_S_DVS_SUBSAMPLE_VERTICAL_FOURTH 3
#define DVX_S_DVS_SUBSAMPLE_VERTICAL_EIGHTH 7

#define DVX_S_DVS_SUBSAMPLE_HORIZONTAL_NONE 0
#define DVX_S_DVS_SUBSAMPLE_HORIZONTAL_HALF 1
#define DVX_S_DVS_SUBSAMPLE_HORIZONTAL_FOURTH 3
#define DVX_S_DVS_SUBSAMPLE_HORIZONTAL_EIGHTH 7
