...
SET(CAER_BASE_LIBS m)
SET(CAER_PKGCONFIG_LIBS_PRIVATE "-lm")

SET(CAER_BASE_LIBS ${CAER_BASE_LIBS} ${CMAKE_THREAD_LIBS_INIT})
FOREACH (LIB ${CMAKE_THREAD_LIBS_INIT})
	SET(CAER_PKGCONFIG_LIBS_PRIVATE "${CAER_PKGCONFIG_LIBS_PRIVATE} ${LIB}")
ENDFOREACH()

# Add realtime support, not needed on MacOS X or Windows.
IF (OS_UNIX AND NOT OS_MACOSX)
	SET(CAER_BASE_LIBS ${CAER_BASE_LIBS} rt)
	SET(CAER_PKGCONFIG_LIBS_PRIVATE "${CAER_PKGCONFIG_LIBS_PRIVATE} -lrt")
ENDIF()

SET(CAER_BASE_LIBS ${CAER_BASE_LIBS} PARENT_SCOPE)
SET(CAER_PKGCONFIG_LIBS_PRIVATE ${CAER_PKGCONFIG_LIBS_PRIVATE} PARENT_SCOPE)
...
MESSAGE(STATUS "CAER_PKGCONFIG_LIBS_PRIVATE is: ${CAER_PKGCONFIG_LIBS_PRIVATE}")
