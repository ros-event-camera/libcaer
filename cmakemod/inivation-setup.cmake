# Execute various useful checks and setup steps:
# - setup global build settings (CMAKE_BUILD_TYPE, CMAKE_INSTALL_PREFIX)
#   and provide support for Clang's libc++ via USE_CLANG_LIBCPP
# - setup C11 and C++17 requirements, prevent symbol leakage
# - include useful cmake packages (GNUInstallDirs, FindPkgConfig)
# - enable compiler cache (ccache)
# - verify that size of void* and size_t agree (useful for low-level operations)
# - add useful definitions for compilation (XOPEN_SOURCE=700, DEFAULT_SOURCE=1,
#   DARWIN_C_SOURCE=1, FILE_OFFSET_BITS=64, USE_MINGW_ANSI_STDIO=1) as needed
# - enable all compiler warnings for GCC and Clang
# - setup RPATH correctly
# - setup linking to only link to libraries with required symbols
# - print info variables for debug purposes
#
# And set several useful variables for common system information:
# - detect compiler (CC_CLANG, CC_GCC, CC_ICC, CC_MSVC)
# - detect operating system (OS_UNIX, OS_LINUX, OS_MACOS, OS_WINDOWS)
# - detect if system big/little-endian in SYSTEM_BIGENDIAN
# - detect thread libraries (HAVE_PTHREADS, HAVE_WIN32_THREADS) and
#   define libs needed for successful linking in SYSTEM_THREAD_LIBS
