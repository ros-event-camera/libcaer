#ifndef LIBCAER_SRC_MIPI_CX3_H_
#define LIBCAER_SRC_MIPI_CX3_H_
...
#define MIPI_CX3_EVENT_TYPES 2

#define MIPI_CX3_POLARITY_DEFAULT_SIZE 8192
#define MIPI_CX3_SPECIAL_DEFAULT_SIZE  128

#define MIPI_CX3_DEVICE_NAME "MIPI CX3 Test"

#define MIPI_CX3_DEVICE_PID                0x8418
#define MIPI_CX3_REQUIRED_FIRMWARE_VERSION 6

#define DEBUG_ENDPOINT      0x81
#define DEBUG_TRANSFER_NUM  4
#define DEBUG_TRANSFER_SIZE 64

#define VENDOR_REQUEST_I2C_CONFIG   0xB7
#define VENDOR_REQUEST_I2C_TRANSFER 0xB8

#define DEVICE_DVS 0x0010
...
#define REGISTER_CONTROL_PLL_M_HIGH           0x300E
#define REGISTER_CONTROL_PLL_M_LOW            0x300F
...
#define REGISTER_CONTROL_PACKET_FULL_SCAN     0x3068

#define REGISTER_MIPI_CONTROL                0x3900
#define REGISTER_MIPI_HEADER_DATA_TYPE       0x3901
#define REGISTER_MIPI_HEADER_WORD_COUNT_LOW  0x3902
#define REGISTER_MIPI_HEADER_WORD_COUNT_HIGH 0x3903
#define REGISTER_MIPI_DPHY_CONTROL           0x3908
#define REGISTER_MIPI_FIFO_CONTROL           0x390B
#define REGISTER_MIPI_FIFO_TIMEOUT           0x390C
#define REGISTER_MIPI_FIFO_TIMEOUT_SUB       0x391E
#define REGISTER_MIPI_FIFO_TIMEOUT_MAIN      0x391F
#define REGISTER_MIPI_LINE_SPACING           0x3919
#define REGISTER_MIPI_FRAME_SPACING_LOW      0x3917
#define REGISTER_MIPI_FRAME_SPACING_HIGH     0x3918
#define REGISTER_MIPI_LINES_PER_FRAME_LOW    0x391A
#define REGISTER_MIPI_LINES_PER_FRAME_HIGH   0x391B
...
#define REGISTER_DIGITAL_FULL_SCAN            0x3231
...
typedef struct mipi_cx3_state *mipiCx3State;

struct mipi_cx3_handle {
	uint16_t deviceType;
	// Information fields
	struct caer_mipi_cx3_info info;
	// State for data management, common to all MIPI_CX3.
	struct mipi_cx3_state state;
};

typedef struct mipi_cx3_handle *mipiCx3Handle;
...
bool mipiCx3DataStart(caerDeviceHandle handle, void (*dataNotifyIncrease)(void *ptr),
	void (*dataNotifyDecrease)(void *ptr), void *dataNotifyUserPtr, void (*dataShutdownNotify)(void *ptr),
	void *dataShutdownUserPtr);
bool mipiCx3DataStop(caerDeviceHandle handle);
caerEventPacketContainer mipiCx3DataGet(caerDeviceHandle handle);

#endif /* LIBCAER_SRC_MIPI_CX3_H_ */
