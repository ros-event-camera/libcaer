...
#define DAVIS_FX2_REQUIRED_LOGIC_VERSION 18
#define DAVIS_FX2_REQUIRED_LOGIC_PATCH_LEVEL 1
#define DAVIS_FX2_REQUIRED_FIRMWARE_VERSION 4

#define DAVIS_FX3_DEVICE_PID 0x841A
#define DAVIS_FX3_REQUIRED_LOGIC_VERSION 18
#define DAVIS_FX3_REQUIRED_LOGIC_PATCH_LEVEL 1
#define DAVIS_FX3_REQUIRED_FIRMWARE_VERSION 6
