...
#define AUTOEXPOSURE_LOW_BOUNDARY 0.20f
#define AUTOEXPOSURE_HIGH_BOUNDARY 0.80f
#define AUTOEXPOSURE_UNDEROVER_FRAC 0.10f
#define AUTOEXPOSURE_OVUN_CORRECTION 100.0f
